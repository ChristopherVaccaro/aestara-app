...
const FILTER_CATEGORIES: FilterCategory[] = [
  ...
  },
  {
    ...
    filters: [
      ...
      { id: 'baroque', name: 'Baroque', prompt: 'Apply Baroque art style (17th-18th century): Dramatic dynamic composition with diagonal movement. Strong chiaroscuro lighting with intense light-shadow contrast. Rich deep colors with golden highlights and jewel tones. Ornate elaborate details with luxurious textures (gold leaf, velvet, silk). Flowing drapery, dramatic gestures. Theatrical emotional grandeur like Caravaggio or Rubens.' },
      { id: 'artnouveau', name: 'Art Nouveau', prompt: 'Apply Art Nouveau style (1890s-1910s): Flowing organic curves and whiplash lines. Floral motifs, vines, peacock feathers, flowing hair. Muted harmonious palette with gold accents. Elegant decorative nature-inspired aesthetic. Intricate linework, stylized natural forms, ornamental borders. Vertical emphasis with flowing compositions. Belle Époque sophistication like Alphonse Mucha posters.' },
