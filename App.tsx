...
const FILTER_CATEGORIES: FilterCategory[] = [
  ...
  },
  {
    ...
    filters: [
      ...
      { id: 'ageprogression', name: 'Age Progression', prompt: 'Apply realistic age progression showing natural mature appearance while preserving exact facial identity and bone structure. CRITICAL - Maintain recognizable facial features, eye shape, nose shape, mouth shape, face proportions, and bone structure. SKIN - Add natural age-appropriate skin texture: fine lines around eyes (crow\'s feet), forehead lines, smile lines around mouth, nasolabial folds. Subtle skin texture changes with slight looseness. Natural age spots or sun spots if appropriate. Slightly less taut skin. HAIR - Natural graying of hair (salt-and-pepper or silver), possible hairline recession or thinning if male, maintained hairstyle but with age-appropriate styling. Natural gray coverage (30-60% gray depending on target age). FACIAL CHANGES - Slight softening of jawline, subtle volume loss in cheeks, natural under-eye changes, fuller earlobes. Eyebrows may thin slightly or gray. EXPRESSION - Mature, wise, dignified expression. Confidence and life experience. LIGHTING - Flattering natural light showing texture but maintaining dignity. Soft directional lighting. SKIN TONE - Mature skin tones, possibly slight color changes, but healthy appearance. AVOID - Extreme aging, unflattering portrayal, dramatic sagging, excessive wrinkles, unhealthy appearance, loss of identity. AIM FOR - Natural graceful aging (adding 20-30 years) like professional age progression software. Dignified mature appearance while person remains completely recognizable. Realistic life-like aging as seen in reunion photos or time-lapse comparisons.' },
    ],
  },
  {
