          ...
          {categories
            ...
            ?.filters.map((filter) => (
              <button
                ...
                disabled={isLoading}
                className="group relative h-[48px] rounded-xl transition-colors duration-200 focus:outline-none disabled:opacity-40 disabled:cursor-not-allowed overflow-hidden"
                title={filter.name}
              >
                ...
                <div className={`relative z-10 px-3 h-full w-full flex items-center justify-center ${
              ...
              <div className="hidden lg:grid grid-cols-2 gap-2.5">
                {category.filters.map((filter) => (
                  <button
                    ...
                    disabled={isLoading}
                    className="group relative h-[44px] rounded-lg transition-all duration-200 focus:outline-none disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-start px-3 overflow-hidden"
                    title={filter.name}
                  >
