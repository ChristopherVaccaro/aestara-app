...
const MobileFloatingButton: React.FC<MobileFloatingButtonProps> = ({ onClick }) => {
  return (
    <div className="fixed bottom-6 right-6 z-40 lg:hidden">
      ...
      <button
        onClick={onClick}
        className="relative w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full shadow-2xl flex items-center justify-center hover:scale-110 active:scale-95 transition-transform duration-200"
