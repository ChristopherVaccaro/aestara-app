...
const FILTER_CATEGORIES = [
  {
    ...
    filters: [
      ...
      { id: 'anime_v2', name: 'Anime Enhanced', prompt: 'Apply cinematic anime key visual rendering style. PRESERVE: Exact facial structure, all facial features, eye shape, nose shape, mouth proportions, face geometry, body pose, clothing design, and composition. STYLE: Anime style, digital painting, vibrant colors, clean line art, soft cell shading, high detail in eyes, expressive facial features, subtle blush, dynamic lighting, character art, trending on ArtStation. Render existing features with anime aesthetic while maintaining perfect facial likeness. LIGHTING: Soft, studio key lighting focused on the face, with gradual shadows and a smooth transition to the background. Eliminate strong rim lights or backlighting. COLOR: Rich, vibrant anime palette. Keep the person 100% recognizable with all unique facial characteristics intact. Only apply anime rendering technique to existing structure.' },
